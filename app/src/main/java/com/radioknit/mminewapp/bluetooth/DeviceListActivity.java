...
package com.radioknit.mminewapp.bluetooth;
    ...
    private final OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            if (info != null) {
                ...
                String address1 = info.toString().substring(info.length() - 17);
                TempSharedPreference.setPairedDeviceAddress(getApplicationContext(), address1);
